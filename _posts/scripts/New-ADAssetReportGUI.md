...
permalink: /scripts/new-adassetreportgui/
categories:
- Scripts
tags:
- PowerShell
- Scripts
- Active Directory Asset Report GUI
- Active Directory
- GUI
description: PowerShell script for active directory asset report GUI.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/scripts/activeDirectory/New-ADAssetReportGUI.ps1')">
...
<a class="github-button" href="https://github.com/BanterBoy/scripts-blog/issues/new?title=New-ADAssetReportGUI.ps1&body=There is a problem with this function. Please find details below." data-show-count="true" aria-label="Issue BanterBoy/scripts-blog on GitHub">Issue</a>
