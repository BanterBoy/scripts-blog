...
permalink: /_posts/scripts/New-KrbtgtKeys/
---
...
<script src="https://gist-it.appspot.com/github.com/BanterBoy/scripts-blog/blob/master/PowerShell/scripts/activeDirectory/New-KrbtgtKeys.ps1
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/scripts/activeDirectory/New-KrbtgtKeys.ps1')">
    <i class="fa fa-cloud-download-alt">
    </i>
        Download
</button>
