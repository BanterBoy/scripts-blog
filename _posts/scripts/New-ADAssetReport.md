...
permalink: /scripts/new-adassetreport/
categories:
- Scripts
tags:
- PowerShell
...
- Active Directory
description: PowerShell script for active directory asset report.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/scripts/activeDirectory/New-ADAssetReport.ps1')">
