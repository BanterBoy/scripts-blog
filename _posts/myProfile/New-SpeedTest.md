...
<button class="btn" type="submit" onclick="window.open('http://agamar.domain.leigh-services.com:4000/powershell/functions/myProfile/New-SpeedTest.ps1')">
    <i class="fa fa-cloud-download-alt">
    </i>
        Download
</button>

<button class="btn" type="submit" onclick="window.open('http://agamar.domain.leigh-services.com:4000/powershell/functions/myProfile/speedtest.exe')">
    <i class="fa fa-cloud-download-alt">
    </i>
        speedtest.exe
</button>
