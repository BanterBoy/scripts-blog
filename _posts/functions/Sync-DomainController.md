...
functions/activeDirectory/Sync-DomainController.ps1
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/functions/activeDirectory/Sync-DomainController.ps1')">
