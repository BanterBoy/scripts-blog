...
<button class="btn" type="submit" onclick="window.open('/PowerShell/functions/Enter-O365Session.ps1')">
...
<script async src="https://gist-it.appspot.com/github.com/BanterBoy/scripts-blog/blob/master/PowerShell/functions/Enter-O365Session.ps1" crossorigin="anonymous"></script>
