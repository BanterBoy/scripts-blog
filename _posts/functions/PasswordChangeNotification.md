...
functions/exchange/PasswordChangeNotification.ps1
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/functions/exchange/PasswordChangeNotification.ps1')">
