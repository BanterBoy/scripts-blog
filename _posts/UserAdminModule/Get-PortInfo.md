...
- User Admin Module
- Port Info
description: PowerShell script for port info.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Network/Public/Get-PortInfo.ps1')">
