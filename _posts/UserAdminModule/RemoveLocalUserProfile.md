...
- User Admin Module
- Local User Profile
description: PowerShell script for local user profile.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/RemoveLocalUserProfile.ps1')">
