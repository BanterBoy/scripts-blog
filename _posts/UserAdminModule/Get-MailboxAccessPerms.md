...
permalink: /_posts/UserAdminModule/Get-MailboxAccessPerms/
categories:
- UserAdminModule
- Exchange
tags:
- PowerShell
- User Admin Module
- Mailbox Access Perms
description: PowerShell script for mailbox access perms.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Get-MailboxAccessPerms.ps1')">
