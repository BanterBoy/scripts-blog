...
- User Admin Module
- Ini Content
description: PowerShell script for ini content.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/FileOperations/Public/Get-IniContent.ps1')">
