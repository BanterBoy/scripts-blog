...
permalink: /_posts/UserAdminModule/Get-PatchTuesday/
categories:
- UserAdminModule
- Utilities
tags:
...
- User Admin Module
- Patch Tuesday
description: PowerShell script for patch tuesday.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Get-PatchTuesday.ps1')">
