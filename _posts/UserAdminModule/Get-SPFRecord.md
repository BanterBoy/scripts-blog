...
permalink: /_posts/UserAdminModule/Get-SPFRecord/
categories:
- UserAdminModule
- Network
tags:
...
- SPF Record
- SPF
description: PowerShell script for SPF record.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Network/Public/Get-SPFRecord.ps1')">
