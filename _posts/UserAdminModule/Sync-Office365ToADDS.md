...
- PowerShell
- User Admin Module
- Office 365 To Active Directory
- Active Directory
- Office 365
description: PowerShell script for office 365 to active directory.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/activeDirectory/Sync-Office365ToADDSps1')">
...
<a class="github-button" href="https://github.com/BanterBoy/scripts-blog/issues/new?title=Sync-Office365ToADDSps1.ps1&body=There is a problem with this function. Please find details below." data-show-count="true" aria-label="Issue BanterBoy/scripts-blog on GitHub">Issue</a>
