...
- User Admin Module
- Pending Updates
description: PowerShell script for pending updates.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Get-PendingUpdates.ps1')">
