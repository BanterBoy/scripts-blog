...
permalink: /_posts/UserAdminModule/Get-KMSclientActivations/
categories:
- UserAdminModule
- Utilities
tags:
- PowerShell
- User Admin Module
- KM Sclient Activations
- KM
description: A brief description of the Get-KMSclientActivations function.
