...
permalink: /_posts/UserAdminModule/Get-UserAccountControlReport/
categories:
- UserAdminModule
- ADFunctions
tags:
...
description: PowerShell script for user account control report.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Get-UserAccountControlReport.ps1')">
