...
permalink: /useradminmodule/network/resolve-domaindns/
---
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Network/Public/Resolve-DomainDNS.ps1')">
