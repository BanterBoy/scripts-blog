...
permalink: /_posts/UserAdminModule/New-BlogServer/
categories:
- UserAdminModule
- JekyllBlog
tags:
...
- User Admin Module
- Blog Server
description: PowerShell script for blog server.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/JekyllBlog/Public/New-BlogServer.ps1')">
