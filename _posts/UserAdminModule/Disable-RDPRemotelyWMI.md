...
permalink: /useradminmodule/remoteconnections/disable-rdpremotelywmi/
---
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/RemoteConnections/Public/Disable-RDPRemotelyWMI.ps1')">
