...
- User Admin Module
- Nested Group Member
description: PowerShell script for nested group member.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Get-NestedGroupMember.ps1')">
