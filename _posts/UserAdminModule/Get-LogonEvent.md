...
- User Admin Module
- Logon Event
description: This PowerShell script is called Get-LogonEvent.ps1 and it retrieves
  logon events from the Microsoft-Windows-Winlogon provider on one or more remote...
