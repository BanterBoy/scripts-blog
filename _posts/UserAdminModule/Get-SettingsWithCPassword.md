...
permalink: /_posts/UserAdminModule/Get-SettingsWithCPassword/
categories:
- UserAdminModule
- Security
tags:
- PowerShell
- User Admin Module
- Settings With C Password
description: PowerShell script for settings with C password.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Security/Public/Get-SettingsWithCPassword.ps1')">
