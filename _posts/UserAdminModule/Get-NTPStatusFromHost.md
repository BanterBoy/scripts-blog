...
permalink: /_posts/UserAdminModule/Get-NTPStatusFromHost/
categories:
- UserAdminModule
- Utilities
tags:
- PowerShell
- User Admin Module
- NTP Status From Host
- NTP
description: PowerShell script for NTP status from host.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Get-NTPStatusFromHost.ps1')">
