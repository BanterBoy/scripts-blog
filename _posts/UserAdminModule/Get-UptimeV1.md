...
- User Admin Module
- Uptime V 1
description: PowerShell script for uptime V 1.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Virtualization/Public/Get-UptimeV1.ps1')">
