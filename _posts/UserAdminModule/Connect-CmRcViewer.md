...
permalink: /_posts/UserAdminModule/Connect-CmRcViewer/
categories:
- UserAdminModule
- RemoteConnections
tags:
...
- User Admin Module
- Cm Rc Viewer
description: Connect-CmRcViewer - Spawn ConfigMgr Remote Control Viewer and launches
  a session to a remote computer.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/RemoteConnections/Public/Connect-CmRcViewer.ps1')">
