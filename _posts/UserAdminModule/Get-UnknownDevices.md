...
permalink: /_posts/UserAdminModule/Get-UnknownDevices/
categories:
- UserAdminModule
- Security
tags:
...
- User Admin Module
- Unknown Devices
description: PowerShell script for unknown devices.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Security/Public/Get-UnknownDevices.ps1')">
