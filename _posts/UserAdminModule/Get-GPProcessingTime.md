...
- GP Processing Time
- GP
description: Get Group Policy Processing time from the Group Policy event log on local
...
Lists additional details of the Group Policy processing duration information Cmp_PrincipalSamName         Cmp_PolicyElaspedTimeInSeconds      Usr_PolicyElaspedTimeInSeconds --------------------         ------------------------------      ------------------------------ CORP\TestClient1$               1                                   2 CORP\TestClient2$               2                                   2 CORP\TestClient3$               12                                  49
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Get-GPProcessingTime.ps1')">
