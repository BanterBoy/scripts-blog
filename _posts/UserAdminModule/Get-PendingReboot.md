...
- User Admin Module
- Pending Reboot
description: PowerShell script for pending reboot.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Get-PendingReboot.ps1')">
