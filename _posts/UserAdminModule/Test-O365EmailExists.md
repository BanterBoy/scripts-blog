...
date: 2025-09-19
permalink: /useradminmodule/testing/test-o365emailexists/
categories:
  - UserAdminModule
  - Testing
---
...
Test-O365EmailExists - A function to The function tests to see if
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Testing/Public/Test-O365EmailExists.ps1')">
