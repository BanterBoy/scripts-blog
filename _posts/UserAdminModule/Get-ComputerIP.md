...
permalink: /_posts/UserAdminModule/Get-ComputerIP/
categories:
- UserAdminModule
- Network
tags:
...
- Computer IP
- IP
description: Get-ComputerIP will extract the current IP from the computer entered.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Network/Public/Get-ComputerIP.ps1')">
