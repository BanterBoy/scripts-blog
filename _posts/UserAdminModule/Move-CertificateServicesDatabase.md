...
permalink: /_posts/UserAdminModule/Move-CertificateServicesDatabase/
categories:
- UserAdminModule
- PKICertificateTools
tags:
- PowerShell
- User Admin Module
- Move Certificate Services Database
description: Move the CA server database to another folder or volume.
