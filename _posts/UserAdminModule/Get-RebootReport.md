...
- User Admin Module
- Reboot Report
description: PowerShell script for reboot report.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Get-RebootReport.ps1')">
