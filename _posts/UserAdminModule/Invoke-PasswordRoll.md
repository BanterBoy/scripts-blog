...
- User Admin Module
- Password Roll
description: PowerShell script for password roll.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Security/Public/Invoke-PasswordRoll.ps1')">
