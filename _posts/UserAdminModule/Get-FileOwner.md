...
- User Admin Module
- File Owner
description: PowerShell script for file owner.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/FileOperations/Public/Get-FileOwner.ps1')">
