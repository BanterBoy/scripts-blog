...
permalink: /_posts/UserAdminModule/Get-MailboxPermissionsExport/
categories:
- UserAdminModule
- Exchange
tags:
- PowerShell
- User Admin Module
- Mailbox Permissions Export
description: PowerShell script for mailbox permissions export.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Get-MailboxPermissionsExport.ps1')">
