...
- User Admin Module
- Run Reg Key
description: Removes a specified registry key from the Run registry path.
...
This function removes a specified registry key from the "HKLM:\Software\Microsoft\Windows\CurrentVersion\Run" path on the local or remote computers. It can accept computer names and credentials as input and uses PowerShell remoting to execute the task on remote systems.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Remove-RunRegKey.ps1')">
...
<a class="github-button" href="https://github.com/BanterBoy/scripts-blog/issues/new?title=Remove-RunRegKey.ps1&body=There is a problem with this function. Please find details below." data-show-count="true" aria-label="Issue BanterBoy/scripts-blog on GitHub">Issue</a>
