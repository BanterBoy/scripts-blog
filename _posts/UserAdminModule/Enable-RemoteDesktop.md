...
permalink: /useradminmodule/remoteconnections/enable-remotedesktop/
---
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/RemoteConnections/Public/Enable-RemoteDesktop.ps1')">
