---
layout: post
title: Invoke-AzureMailApp.ps1
date: 2025-09-19
permalink: /_posts/UserAdminModule/Invoke-AzureMailApp/
categories:
  - UserAdminModule
  - Azure
---
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Azure/Public/Invoke-AzureMailApp.ps1')">
...
<a class="github-button" href="https://github.com/BanterBoy/scripts-blog/issues/new?title=Invoke-AzureMailApp.ps1&body=There is a problem with this function. Please find details below." data-show-count="true" aria-label="Issue BanterBoy/scripts-blog on GitHub">Issue</a>
