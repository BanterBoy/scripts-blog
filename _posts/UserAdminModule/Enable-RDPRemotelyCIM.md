...
- RDP
- CIM
description: Use Enable-RDPRemotelyCIM to turn on Remote Desktop across one or more
  systems via the CIM Win32_TerminalServiceSetting class. The function enables both
  the...
