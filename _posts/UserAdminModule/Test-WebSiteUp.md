...
- User Admin Module
- Web Site Up
description: PowerShell script for web site up.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Testing/Public/Test-WebSiteUp.ps1')">
