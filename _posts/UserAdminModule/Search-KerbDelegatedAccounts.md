...
- PowerShell
- User Admin Module
- Kerb Delegated Accounts
description: PowerShell script for kerb delegated accounts.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Search-KerbDelegatedAccounts.ps1')">
