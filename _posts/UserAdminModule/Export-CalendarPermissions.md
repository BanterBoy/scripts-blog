...
permalink: /_posts/UserAdminModule/Export-CalendarPermissions/
categories:
- UserAdminModule
- Exchange
tags:
...
description: PowerShell script for calendar permissions.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Export-CalendarPermissions.ps1')">
