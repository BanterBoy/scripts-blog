...
permalink: /_posts/UserAdminModule/Get-ServerTimeZone/
categories:
- UserAdminModule
- Utilities
tags:
...
- User Admin Module
- Server Time Zone
description: A brief description of the Get-ServerTimeZone function.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Get-ServerTimeZone.ps1')">
