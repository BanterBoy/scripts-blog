...
permalink: /_posts/UserAdminModule/Get-InstalledDotNetVersions/
categories:
- UserAdminModule
- Utilities
tags:
- PowerShell
- User Admin Module
- Installed Dot Net Versions
description: Retrieves the installed versions of .NET Framework on the system.
