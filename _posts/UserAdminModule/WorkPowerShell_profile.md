...
- PowerShell
- User Admin Module
- Work Power Shell Profile
description: PowerShell script for work power shell profile.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Shell/Configuration/personalProfiles/WorkPowerShell_profile.ps1')">
