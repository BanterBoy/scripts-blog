...
- User Admin Module
- Email Address
description: PowerShell script for email address.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Testing/Public/Test-EmailAddress.ps1')">
