...
permalink: /_posts/UserAdminModule/Test-ComputerName/
categories:
- UserAdminModule
- Testing
tags:
...
- User Admin Module
- Computer Name
description: PowerShell script for computer name.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Testing/Public/Test-ComputerName.ps1')">
