...
permalink: /useradminmodule/mediamanagement/start-stream/
---
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/MediaManagement/Public/Start-Stream.ps1')">
