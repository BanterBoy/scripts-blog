...
- PowerShell
- User Admin Module
- Last Installed Application
description: A brief description of the Get-LastInstalledApplication function.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Get-LastInstalledApplication.ps1')">
