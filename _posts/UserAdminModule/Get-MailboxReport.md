...
- User Admin Module
- Mailbox Report
description: PowerShell script for mailbox report.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Get-MailboxReport.ps1')">
