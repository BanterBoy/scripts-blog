...
permalink: /_posts/UserAdminModule/Get-CidrIPRange/
categories:
- UserAdminModule
- Network
tags:
...
- Cidr IP Range
- IP
description: Short function to display the details for a CIDR range
...
Address       = 192.168.1.1 Network       = 192.168.1.0 / 24 Netmask       = 255.255.255.0 Broadcast     = 192.168.1.255 Wildcard Mask = 0.0.0.255 Hosts Bits    = 8 Max. Hosts    = 254   (2^8 - 2) Host Range    = { 192.168.1.1 - 192.168.1.254 }
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Network/Public/Get-CidrIPRange.ps1')">
