...
permalink: /_posts/UserAdminModule/MoveOU/
categories:
- UserAdminModule
- ADFunctions
tags:
...
- Move OU
- OU
description: PowerShell script for move OU.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/MoveOU.ps1')">
