...
- User Admin Module
- Auto Discover
description: PowerShell script for auto discover.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Set-AutoDiscover.ps1')">
