...
date: 2025-09-19
permalink: /useradminmodule/exchange/get-adexchangeserver/
categories:
  - UserAdminModule
  - Exchange
---
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Get-ADExchangeServer.ps1')">
