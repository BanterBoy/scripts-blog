...
- User Admin Module
- Jekyll Blog Session
description: Creates a new blog session by setting up a new PowerShell drive and opening
  the code editor.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/JekyllBlog/Public/New-JekyllBlogSession.ps1')">
...
<a class="github-button" href="https://github.com/BanterBoy/scripts-blog/issues/new?title=New-JekyllBlogSession.ps1&body=There is a problem with this function. Please find details below." data-show-count="true" aria-label="Issue BanterBoy/scripts-blog on GitHub">Issue</a>
