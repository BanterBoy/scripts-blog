...
- User Admin Module
- Lock User Input
description: PowerShell script for lock user input.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Shell/Public/Lock-UserInput.ps1')">
