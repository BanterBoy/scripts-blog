...
permalink: /_posts/UserAdminModule/Get-MailboxPermissionsReport/
categories:
- UserAdminModule
- Exchange
tags:
...
description: PowerShell script for mailbox permissions report.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Get-MailboxPermissionsReport.ps1')">
