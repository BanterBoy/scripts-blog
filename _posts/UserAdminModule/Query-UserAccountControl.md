...
- PowerShell
- User Admin Module
- Query User Account Control
description: PowerShell script for query user account control.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Query-UserAccountControl.ps1')">
