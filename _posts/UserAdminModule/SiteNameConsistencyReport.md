...
permalink: /_posts/UserAdminModule/SiteNameConsistencyReport/
categories:
- UserAdminModule
- ADFunctions
tags:
- PowerShell
- User Admin Module
- Site Name Consistency Report
description: PowerShell script for site name consistency report.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/SiteNameConsistencyReport.ps1')">
