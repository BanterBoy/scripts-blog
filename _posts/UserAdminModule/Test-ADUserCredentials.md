...
permalink: /_posts/UserAdminModule/Test-ADUserCredentials/
categories:
- UserAdminModule
- ADFunctions
tags:
...
- Active Directory
description: PowerShell script for active directory user credentials.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Test-ADUserCredentials.ps1')">
