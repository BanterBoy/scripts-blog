...
permalink: /_posts/UserAdminModule/Get-TokenSizeReport/
categories:
- UserAdminModule
- ADFunctions
tags:
...
- User Admin Module
- Token Size Report
description: PowerShell script for token size report.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Get-TokenSizeReport.ps1')">
...
<a class="github-button" href="https://github.com/BanterBoy/scripts-blog/issues/new?title=Get-TokenSizeReport.ps1&body=There is a problem with this function. Please find details below." data-show-count="true" aria-label="Issue BanterBoy/scripts-blog on GitHub">Issue</a>
