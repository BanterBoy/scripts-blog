...
- PowerShell
- User Admin Module
- O 365 Last Logon Time
description: PowerShell script for O 365 last logon time.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Get-O365LastLogonTime.ps1')">
