...
- User Admin Module
- Password
description: PowerShell script for password.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Security/Public/New-Password.ps1')">
