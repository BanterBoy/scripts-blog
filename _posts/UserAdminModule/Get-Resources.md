...
- User Admin Module
- Resources
description: PowerShell script for resources.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Get-Resources.ps1')">
