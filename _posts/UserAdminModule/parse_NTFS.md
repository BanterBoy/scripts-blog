...
- Parse NTFS
- NTFS
description: PowerShell script for parse NTFS.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/FileOperations/Public/parse_NTFS.ps1')">
