...
description: Retrieves Outlook appointments within a specified date range.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Shell/Public/Get-OutlookAppointments.ps1')">
