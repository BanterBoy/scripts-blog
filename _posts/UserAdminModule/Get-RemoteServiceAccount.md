...
description: PowerShell script for remote service account.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Get-RemoteServiceAccount.ps1')">
