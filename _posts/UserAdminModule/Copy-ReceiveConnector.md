...
permalink: /_posts/UserAdminModule/Copy-ReceiveConnector/
categories:
- UserAdminModule
- Exchange
tags:
...
- User Admin Module
- Receive Connector
description: PowerShell script for receive connector.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Copy-ReceiveConnector.ps1')">
