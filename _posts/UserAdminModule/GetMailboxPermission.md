...
- User Admin Module
- Mailbox Permission
description: PowerShell script for mailbox permission.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/GetMailboxPermission.ps1')">
