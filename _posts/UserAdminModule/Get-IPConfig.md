...
- IP Config
- IP
description: PowerShell script for IP config.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Network/Public/Get-IPConfig.ps1')">
