---
layout: post
title: Get-UptimeResult.ps1
date: 2025-09-19
last_modified_at: 2025-09-20 00:00:00
permalink: /_posts/UserAdminModule/Get-UptimeResult/
categories:
- UserAdminModule
- Virtualization
tags:
...
- User Admin Module
- Uptime Result
description: Get-Uptime will extract the current system uptime from the computer entered.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Virtualization/Public/Get-UptimeResult.ps1')">
...
<a class="github-button" href="https://github.com/BanterBoy/scripts-blog/issues/new?title=Get-UptimeResult.ps1&body=There is a problem with this function. Please find details below." data-show-count="true" aria-label="Issue BanterBoy/scripts-blog on GitHub">Issue</a>
