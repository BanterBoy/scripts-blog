...
- User Admin Module
- Windows Update
description: PowerShell script for windows update.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Start-WindowsUpdate.ps1')">
