...
- Group Policy
description: PowerShell script for unlinked group policy.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Get-UnlinkedGPO.ps1')">
