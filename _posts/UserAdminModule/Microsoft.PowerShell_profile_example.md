...
permalink: /_posts/UserAdminModule/Microsoft.PowerShell_profile_example/
categories:
- UserAdminModule
- Shell
tags:
- PowerShell
- User Admin Module
- Microsoft Power Shell Profile Example
description: PowerShell script for microsoft power shell profile example.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Shell/Configuration/Examples/Microsoft.PowerShell_profile_Example.ps1')">
