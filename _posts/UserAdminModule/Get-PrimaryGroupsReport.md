...
permalink: /_posts/UserAdminModule/Get-PrimaryGroupsReport/
categories:
- UserAdminModule
- ADFunctions
tags:
...
description: PowerShell script for primary groups report.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Get-PrimaryGroupsReport.ps1')">
