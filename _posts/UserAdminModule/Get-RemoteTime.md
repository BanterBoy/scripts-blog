...
permalink: /_posts/UserAdminModule/Get-RemoteTime/
categories:
- UserAdminModule
- Utilities
tags:
...
- User Admin Module
- Remote Time
description: PowerShell script for remote time.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Get-RemoteTime.ps1')">
