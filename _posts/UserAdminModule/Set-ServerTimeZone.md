...
permalink: /_posts/UserAdminModule/Set-ServerTimeZone/
categories:
- UserAdminModule
- Utilities
tags:
...
- User Admin Module
- Server Time Zone
description: A brief description of the Set-ServerTimeZone function.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Set-ServerTimeZone.ps1')">
