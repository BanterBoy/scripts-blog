...
permalink: /_posts/UserAdminModule/Test-OnlineFast/
categories:
- UserAdminModule
- Testing
tags:
...
- User Admin Module
- Online Fast
description: PowerShell script for online fast.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Testing/Public/Test-OnlineFast.ps1')">
