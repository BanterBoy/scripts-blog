...
permalink: /_posts/UserAdminModule/GetUserLoggedOnto/
categories:
- UserAdminModule
- ADFunctions
tags:
...
- User Admin Module
- User Logged Onto
description: PowerShell script for user logged onto.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/GetUserLoggedOnto.ps1')">
