...
- PowerShell
- User Admin Module
- Message Trace Filtered
description: Retrieves message trace results filtered by various parameters such as
  sender address, recipient address, status, subject, MessageId, and date range.
