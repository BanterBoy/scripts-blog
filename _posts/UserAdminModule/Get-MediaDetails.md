...
- User Admin Module
- Media Details
description: PowerShell script for media details.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/FileOperations/Public/Get-MediaDetails.ps1')">
