...
- User Admin Module
- Print Spooler
description: A brief description of the Enable-PrintSpooler function.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/PrintManagement/Public/Enable-PrintSpooler.ps1')">
