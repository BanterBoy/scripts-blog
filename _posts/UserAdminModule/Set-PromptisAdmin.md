---
layout: post
title: Set-PromptisAdmin.ps1
date: 2025-09-19
permalink: /_posts/UserAdminModule/Set-PromptisAdmin/
categories:
  - UserAdminModule
  - Shell
---
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Shell/Public/Set-PromptisAdmin.ps1')">
...
<a class="github-button" href="https://github.com/BanterBoy/scripts-blog/issues/new?title=Set-PromptisAdmin.ps1&body=There is a problem with this function. Please find details below." data-show-count="true" aria-label="Issue BanterBoy/scripts-blog on GitHub">Issue</a>
