...
permalink: /_posts/UserAdminModule/Log-Event/
categories:
- UserAdminModule
- Logging
tags:
...
- User Admin Module
- Event
description: A function to log events.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Logging/Public/Log-Event.ps1')">
...
<a class="github-button" href="https://github.com/BanterBoy/scripts-blog/issues/new?title=Log-Event.ps1&body=There is a problem with this function. Please find details below." data-show-count="true" aria-label="Issue BanterBoy/scripts-blog on GitHub">Issue</a>
