...
- User Admin Module
- Unlock User Account
description: PowerShell script for unlock user account.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Unlock-UserAccount.ps1')">
