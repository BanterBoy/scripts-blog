...
permalink: /_posts/UserAdminModule/Restart-ExchangeServices/
categories:
- UserAdminModule
- Exchange
tags:
...
- Exchange Services
- Exchange
description: PowerShell script for exchange services.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Restart-ExchangeServices.ps1')">
