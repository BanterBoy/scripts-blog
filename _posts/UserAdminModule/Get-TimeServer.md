...
- User Admin Module
- Time Server
description: PowerShell script for time server.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Utilities/Public/Get-TimeServer.ps1')">
