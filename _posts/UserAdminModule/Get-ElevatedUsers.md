...
permalink: /_posts/UserAdminModule/Get-ElevatedUsers/
categories:
- UserAdminModule
- ADFunctions
tags:
...
- User Admin Module
- Elevated Users
description: PowerShell script for elevated users.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Get-ElevatedUsers.ps1')">
