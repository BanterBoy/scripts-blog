...
- User Admin Module
- Group Policy
description: PowerShell script for group policy.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Search-GPO.ps1')">
