...
- PowerShell
- User Admin Module
- Active Directory Userto Local Group
- Active Directory
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Add-ADUsertoLocalGroup.ps1')">
