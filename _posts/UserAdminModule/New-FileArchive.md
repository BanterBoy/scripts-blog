...
- User Admin Module
- File Archive
description: PowerShell script for file archive.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/FileOperations/Public/New-FileArchive.ps1')">
