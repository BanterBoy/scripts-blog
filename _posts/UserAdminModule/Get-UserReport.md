...
- User Admin Module
- User Report
description: PowerShell script for user report.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Get-UserReport.ps1')">
