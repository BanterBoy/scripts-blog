...
- Office 365
description: Adds Office 365 PowerShell modules to the current session.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Add-Office365Functions.ps1')">
