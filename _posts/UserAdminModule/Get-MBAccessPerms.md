...
- MB Access Perms
- MB
description: PowerShell script for MB access perms.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Get-MBAccessPerms.ps1')">
