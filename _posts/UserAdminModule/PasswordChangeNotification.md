...
permalink: /_posts/UserAdminModule/PasswordChangeNotification/
categories:
- UserAdminModule
- Exchange
tags:
...
description: PowerShell script for password change notification.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/PasswordChangeNotification.ps1')">
