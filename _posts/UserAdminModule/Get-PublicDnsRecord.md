...
- Public DNS Record
- DNS
description: PowerShell script for public DNS record.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Network/Public/Get-PublicDnsRecord.ps1')">
