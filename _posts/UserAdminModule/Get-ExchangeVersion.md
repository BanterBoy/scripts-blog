...
permalink: /_posts/UserAdminModule/Get-ExchangeVersion/
categories:
- UserAdminModule
- Exchange
tags:
...
- Exchange Version
- Exchange
description: Retrieves Exchange server version information using registry for rollup
  info Outputs objects which can be post-processed or filtered.
...
Retrieves Exchange server version information using registry for rollup info Outputs objects which can be post-processed or filtered.

Michel de Rooij michel@eightwone.com http://eightwone.com
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Get-ExchangeVersion.ps1')">
