...
- User Admin Module
- Enter O 365 Session
description: PowerShell script for enter O 365 session.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Enter-O365Session.ps1')">
