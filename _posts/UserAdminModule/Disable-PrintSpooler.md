...
permalink: /_posts/UserAdminModule/Disable-PrintSpooler/
categories:
- UserAdminModule
- PrintManagement
tags:
...
- User Admin Module
- Print Spooler
description: A brief description of the Disable-PrintSpooler function.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/PrintManagement/Public/Disable-PrintSpooler.ps1')">
