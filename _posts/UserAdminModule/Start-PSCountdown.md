...
permalink: /_posts/UserAdminModule/Start-PSCountdown/
categories:
- UserAdminModule
- Shell
tags:
...
description: PowerShell script for powershell countdown.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Shell/Public/Start-PSCountdown.ps1')">
