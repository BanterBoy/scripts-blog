...
- PowerShell
- User Admin Module
- Microsoft Power Shell Profile
description: PowerShell script for microsoft power shell profile.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Shell/Configuration/General/Microsoft.PowerShell_profile.ps1')">
