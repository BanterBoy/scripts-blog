...
permalink: /useradminmodule/exchange/connect-exchangeserver/
---
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Connect-ExchangeServer.ps1')">
