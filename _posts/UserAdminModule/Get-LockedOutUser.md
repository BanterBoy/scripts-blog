...
- User Admin Module
- Locked Out User
description: PowerShell script for locked out user.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/ADFunctions/Public/Get-LockedOutUser.ps1')">
