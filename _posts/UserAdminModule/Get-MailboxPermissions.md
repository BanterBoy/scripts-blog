...
- User Admin Module
- Mailbox Permissions
description: PowerShell script for mailbox permissions.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/Exchange/Public/Get-MailboxPermissions.ps1')">
