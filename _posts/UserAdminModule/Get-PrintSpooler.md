...
permalink: /_posts/UserAdminModule/Get-PrintSpooler/
categories:
- UserAdminModule
- PrintManagement
tags:
...
- User Admin Module
- Print Spooler
description: A brief description of the Get-PrintSpooler function.
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/PrintManagement/Public/Get-PrintSpooler.ps1')">
