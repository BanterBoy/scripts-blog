...
permalink: /_posts/UserAdminModule/Connect-PSExec/
categories:
- UserAdminModule
- RemoteConnections
tags:
...
- User Admin Module
- PowerShell Exec
description: Connect-PSExec - Spawn PSEXEC and launches a PSEXEC PowerShell or Command
...
<button class="btn" type="submit" onclick="window.open('/PowerShell/UserAdminModule/RemoteConnections/Public/Connect-PSExec.ps1')">
