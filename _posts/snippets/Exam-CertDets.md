...
- Snippets
- Exam Cert Dets
description: This PowerShell script is designed to allow the user to view the details
  of a certificate file without the need to import it into their certificate store....
